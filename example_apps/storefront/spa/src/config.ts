...
/** One coach on the landing "corner" grid. */
...
/** One member testimonial on the landing reviews grid. */
...
export const BUSINESS = {
  ...
  // ── Section headings (landing eyebrow + title per section) ──
  sections: {
    classes: { eyebrow: "Classes", title: "Find your round." },
    coaches: { eyebrow: "The corner", title: "Coaches who watch every round." },
    reviews: { eyebrow: "In their words", title: "People stick around." },
  },

  // ── Landing: coaches ──
  coaches: [
    { name: "Elena Rivera", title: "Head Coach", bio: "Regional Golden Gloves champion. Fifteen years turning nervous first-timers into confident boxers." },
    { name: "Marko Petrov", title: "Strength & Conditioning", bio: "Ex-national-team S&C coach. Builds the engine behind every good round — power, core, and staying power." },
    { name: "Amara Okafor", title: "Sparring & Technique", bio: "Former pro with 20 bouts. Obsessed with clean footwork, timing, and defense that holds up." },
    { name: "Jordan Lin", title: "Youth Program Lead", bio: "Youth development specialist who makes the gym the best hour of a kid's week." },
  ] satisfies Coach[],

  // ── Landing: testimonials ──
  testimonials: [
    { quote: "Walked in terrified, six months later I won my first amateur bout. This place changes people.", by: "Dre M.", detail: "Member since 2023" },
    { quote: "The coaching is unreal — they actually watch you and fix the small things nobody else notices.", by: "Priya S.", detail: "Beginner → Sparring" },
    { quote: "Best hour of my day. I always leave lighter than I came in.", by: "Marcus T.", detail: "Conditioning regular" },
