...
- [`blog/`](../../example_apps/blog) — public app, three-way nav (signed out / reader / owner)
- [`plant_tracker/`](../../example_apps/plant_tracker) — private app, whole-page sign-in gate
- [`storefront/`](../../example_apps/storefront) — sign-in-gated form on a public site
- [`event_rsvp/`](../../example_apps/event_rsvp) — public reads, signed-in writes
